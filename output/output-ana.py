...
#GOTM-lake data
    ...
    Fish_lake=gotmlake_nc.variables['foodweb_water_sDFiAd'][start:stop,:,0,0].T     +gotmlake_nc.variables['foodweb_water_sDFiJv'][start:stop,:,0,0].T
    ...
    df_lake[f_lake]=pd.concat([df_tm_lake,df_O2_lake,df_TN_lake,df_TP_lake,                                    df_PAR_lake,df_Phyto_lake,df_Zoo_lake,                                     df_Fish_lake],axis=1,keys=['tm','O2','TN','TP',                                                               'PAR','Phy','Zoo','Fis'])   
...
# add columns for variables
com_1d2.text(0.15,0.95,'PAR',**{'fontsize':8})
com_1d2.text(0.38,0.95,'Phytoplankton',**{'fontsize':8})
com_1d2.text(0.55,0.95,'Zooplankton',**{'fontsize':8})
com_1d2.text(0.75,0.95,'Fish',**{'fontsize':8})
